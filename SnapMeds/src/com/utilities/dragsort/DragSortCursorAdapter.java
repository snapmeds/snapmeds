...
/**
 * Code taken from https://github.com/bauerca/drag-sort-listview
 * 
 * We have added a PersistenceHandler member to allow more specific callbacks
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements
	...
	private DragSortCallback persistenceHandler;
	...
	public DragSortCallback getPersistenceHandler() {
		return persistenceHandler;
	}
	
	public void setPersistenceHandler(DragSortCallback p) {
	...
	private void updatePersistence(int to, int from) {
		if (persistenceHandler != null) {
			persistenceHandler.reorder(to, from);
		}
	}
	...
	public void remove(int which) {
		...
		persistenceHandler.remove(which);
